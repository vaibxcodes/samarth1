        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Corrugated Boxes</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Food Packaging</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Retail Packaging</a></li>
            </ul>
          </div>
